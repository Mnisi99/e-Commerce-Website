$(document).ready(function() {
    ...
    function searchItem(searchItem, items) {
        ...
        const searchValue = searchItem.val().trim();
    ...
    function addCartItems(allItems, addedItems, size) {
        ...
        allItems.forEach(item => {
            ...
            if (!isDuplicate) {
                ...
                $existingElement.find('li:contains("Price")').text(`Price: ${formatter.format(item.itemPrice)}`)
            }
            ...
            if (cartItems.length > 0) {
                ...
                $('.cartTotal').text(`Total Price: ${formatter.format(total)}`);
            }
        });
    }
